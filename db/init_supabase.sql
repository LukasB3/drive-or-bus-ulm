-- TABLE 1: PARKING LOT METADATA (Static, gets upserted when garages change or new ones are added)
...
-- TABLE 2: PARKING STATUS (Dynamic, insert every 5 minute)
CREATE TABLE IF NOT EXISTS public.parking_status (
    ...
    forecast_occupancy INTEGER,        -- v2 will include forecast occupancy based on historical patterns
